/**
 * File jCodeLibrary ReflectionUtil.java created Mar 26, 20221:01:14 AM
 * 
 * @author: jsmith
 * 
 */
...
{
    public static <F, T extends F> void copyOf(final F from, final T to, final boolean ignoreFinal)
    ...
    public static <F, T extends F> void copyOf(final F from, final T to)
            throws NoSuchFieldException, IllegalAccessException
    {
