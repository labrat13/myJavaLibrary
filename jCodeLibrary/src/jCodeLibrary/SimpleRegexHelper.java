...
public class SimpleRegexHelper extends RegexHelperBase
{
     ...
     * @param argCounter Порядковый номер аргумента в выражении.
     ...
     * @param simpleRegex Строка простого регекса.
     ...
     * @param line Строка с аргументами в стиле Простой регекс.
     * @param args Список значений для аргументов, строго по порядку аргументов.
