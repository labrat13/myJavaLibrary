...
public class RegexHelperBase
{
     ...
     * @param p Инициализированный объект регекса: Pattern p = Pattern.compile(pattern);
     * @param query Текст для поиска совпадений.
...
//            int end = m.end();
     ...
     * @param title Проверяемое название для группы
